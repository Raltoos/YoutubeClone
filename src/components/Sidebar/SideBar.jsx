...
export default function SideBar() {
  return (
    <div className="md:w-5/12 h-[calc(100vh-64px)] sticky overflow-hidden hover:overflow-y-scroll hover:overflow-x-hidden hover:scrollbar-thin hover:scrollbar-webkit hover:outline-none flex flex-col items-start gap-3">
